...
def main(url_keys):
    ...
    try:
        ...
        for i in html_tags:
            ...
            h['Price_check_resort'] = f'https://search.resort-holiday.com/bron_person?CATCLAIM={i.get("data-cat-claim")}&CURRENCY=1&TOWNFROMINC=1&STATEINC={url_keys["STATEINC"]}&PACKET=2&GUEST=1'
